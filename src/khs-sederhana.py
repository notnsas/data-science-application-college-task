def tampil():
    while True:
        try:
            pilihan = int(input('Masukkan Pilihan Matkul (1-10): '))
            if pilihan < 1 or pilihan > 10:
                print("Pilihan harus antara 1 sampai 10. Silakan coba lagi.")
                continue
...
def menu_matkul():
    ...
    print('3. Data Mining (2 sks)')
    print('4. Feature Engineering (2 sks)')
    print('5. Jaringan Syaraf Tiruan (3 sks)')
    print('6. Kewarganegaraan (2 sks)')
    print('7. Manajemen dan Infrastruktur Data (3 sks)')
    print('8. Statistika Inferensial Lanjut (2 sks)')
    print('9. Statistika Inferensial Lanjut Praktik (1 sks)')
    print('10. Agama Islam (2 sks)')
